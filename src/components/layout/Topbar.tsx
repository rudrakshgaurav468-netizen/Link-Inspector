            ...
            <div className="absolute top-full left-0 mt-1.5 w-64 bg-white border border-slate-200 rounded-2xl shadow-elevated z-50 p-2 animate-slide-down">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2 truncate text-left">
                        <Globe className={`w-3.5 h-3.5 ${isSelected ? 'text-emerald-600' : 'text-slate-400'}`} />
              ...
              <div className="border-t border-slate-100 my-1 pt-1 space-y-0.5">
                <button
                  ...
                  className="w-full flex items-center gap-2 p-2 text-xs text-emerald-600 hover:bg-emerald-50 rounded-xl font-bold transition-colors"
                >
          ...
          <h1 className="text-sm font-bold text-slate-900 tracking-tight flex items-center gap-2 truncate">
            ...
            {activeView === 'broken' && (
              <span className={`px-2 py-0.5 rounded-full text-xs font-bold ${
                activeIssuesCount === 0 ? 'bg-emerald-100 text-emerald-800' : 'bg-rose-100 text-rose-700'
              }`}>
        ...
        <form onSubmit={handleQuickScan} className="hidden lg:flex items-center gap-1.5">
          <div className="relative w-56">
            ...
            <input
              ...
              className="w-full pl-8 pr-2 py-1.5 bg-slate-50 hover:bg-slate-100/80 focus:bg-white border border-slate-200 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all font-mono"
            />
          </div>
          <Button
            type="submit"
        ...
        {(activeView === 'links' || activeView === 'broken' || activeView === 'dashboard') && (
          <div className="relative w-36 sm:w-48">
            ...
            <input
              ...
              className="w-full pl-8 pr-2 py-1.5 bg-slate-50 hover:bg-slate-100/70 focus:bg-white border border-slate-200 rounded-xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
            />
          </div>
        )}
