...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-gradient-to-b from-slate-100/70 via-slate-50 to-white">
      ...
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[800px] h-[360px] bg-rose-400/10 blur-[120px] rounded-full pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-rose-50 border border-rose-200/80 shadow-subtle text-rose-800 text-xs font-semibold animate-fade-in">
            <span className="text-rose-700">New: 2026 Amazon ASIN & Stock Availability Engine</span>
            <ArrowRight className="w-3.5 h-3.5 text-rose-600 ml-0.5" />
          </div>
        </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-5 border-b border-slate-200">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-rose-700 bg-rose-100 px-2 py-0.5 rounded-full">Monitored</span>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="bg-white rounded-xl p-3 border border-rose-200 shadow-subtle">
                    <p className="text-[11px] font-semibold text-rose-600 uppercase">Healthy</p>
                    <p className="text-xl font-bold text-rose-600 mt-0.5 font-tabular">1,228</p>
                  </div>
                  <div className="bg-white rounded-xl p-3 border border-rose-200 shadow-subtle">
